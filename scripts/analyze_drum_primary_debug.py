...
RULE_FLAG_BITS = (
    ...
    ("flag_high_band_kick_body_tom_bleed", 1 << 11),
    ...
    ("flag_deep_kick_snare_active_bleed", 1 << 16),
    ("flag_crash_hihat_active_bleed", 1 << 17),
    ("flag_hihat_crash_active_bleed", 1 << 18),
    ...
    ("flag_snare_body_hihat_active_bleed", 1 << 23),
    ("flag_hihat_tom_active_bleed", 1 << 24),
)
ROW_DUMP_FIELDS = (
    [
        "sample",
