...
| [ENST-Drums annotations](https://github.com/georgid/ENST-drums-dataset) | Candidate real-drum Tom/Ride/Rim gate; not yet automated | The original [ENST-Drums paper](https://ismir2006.ismir.net/PAPERS/ISMIR0627_Paper.pdf) describes three professional drummers, eight recorded microphone channels, stereo drum mixes, accompaniment material, and time/event labels covering rim/cross-stick, multiple toms, ride, and crash. Audio distribution is research-use only and requires a signed access agreement, so the GitHub annotation mirror alone is not usable evidence. |
