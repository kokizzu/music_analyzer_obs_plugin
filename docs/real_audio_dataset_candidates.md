...
| [ENST-Drums](https://perso.telecom-paristech.fr/grichard/ENST-drums/) | Candidate real-drum Tom/Ride/Rim gate; not yet automated | Three professional drummers, eight recorded microphone channels, stereo drum mixes, accompaniment material, and time/event labels covering rim/cross-stick, multiple toms, ride, and crash. The official public subset requires accepting research-use licence terms. A 2.85 GB 16 kHz prepared [Zenodo archive](https://zenodo.org/records/7831843) is publicly mirrored with MD5 `7e28c2a923e4f4162b3d83877cedb5eb`; its bundled licence must be preserved and reviewed before use. |
