...
`make test-downloaded-guitarset` downloads [GuitarSet](https://zenodo.org/records/3371780) annotations plus the mono microphone audio into `build/real_sample_sources/guitarset`, prepares `build/guitarset-manifest.tsv`, and runs isolated-guitar note/chord regression over all usable annotated chord windows. `make analyze-guitarset-misses` reruns the same manifest with verbose chord-miss logging, writes `build/guitarset_verbose.log`, and prints the largest expected-quality and same-root miss classes. The prepared manifest contains 360 excerpts; the current usable mono-mic gate covers 209 excerpts, 1,528 selected windows, and 1,491 chord-checkable windows, reporting pitch recall, guitar-row precision/recall/F1, cross-row contamination, exact chord precision/recall, simplified root/quality chord recall, major/minor versus other chord hits, and per-quality chord hits. Current local results are 3,607/5,451 pitch-class hits, 67.97% guitar precision, 66.17% guitar recall, 67.06% guitar F1, and 637/1,491 exact chord hits: 440/752 major/minor opportunities and 197/739 other-chord opportunities. The same run reports 789/1,491 simplified-compatible chord hits, including 464/752 major/minor opportunities; this distinguishes missed extensions from completely wrong chord roots. The Makefile gate now enforces minimum real-audio chord buckets for exact overall, exact major/minor, exact other, simplified overall, simplified major/minor, and simplified other chord recall, so chord handling cannot pass solely on the broad aggregate. The quality breakdown currently shows major 308/500 exact and 329/500 simplified, minor 125/255 exact and 130/255 simplified, sus2 40/88, sus4 35/88, 7th 51/160, maj7 34/202, m7 31/173, 9th 9/38, add9 12/61, 6th 24/173, m6 9/57, dim 5/26, and augmented/diminished-seventh/power shapes still weak. This is a real-audio detector benchmark, not a perfect-truth pass/fail for every chord shape: major/minor chords are prioritized, while sus, diminished, augmented, seventh, ninth, add9, sixth, and power-chord templates are still counted and reported. The cached analyzer phase currently runs in about 22.70 seconds after extraction; first download is about 663 MB and can take much longer.
