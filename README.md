...
`make test-real-note-samples-full-mix` reuses the same NSynth fixtures but analyzes them as a generic full-mix `Speaker Monitor` source. It requires the expected pitch class to appear in any visible note row, enforces at least `REAL_NOTE_FULL_MIX_MIN_EXPECTED_ROW_PERCENT` expected-family row ownership (default 25), and caps false drum lighting from melodic one-note audio with `REAL_NOTE_FULL_MIX_MAX_DRUM_ACTIVE_PERCENT` (default 25). Current cached local results are 2,212/2,212 full-mix any-row pitch hits, 566/2,212 expected-family row hits, and 110/2,242 analyzed windows with any drum row active after tonal sustain suppression; before that suppression the same audit saw 2,358/2,399 melodic windows light drums. The gate also prints a per-family row-confusion matrix, currently showing that most non-owned detections land in the ambiguous row plus guitar/piano crossover. This gate is included in `make test-real-world-samples` because it catches the generic speaker/music-source path that isolated-source tests do not exercise.
...
Current local results are 4,371/5,451 pitch-class hits, 66.67% guitar precision, 80.19% guitar recall, 72.81% guitar F1, and 1,020/1,491 exact chord hits: 630/752 major/minor opportunities and 390/739 other-chord opportunities.
The same run reports 1,122/1,491 simplified-compatible chord hits, including 637/752 major/minor opportunities; this distinguishes missed extensions from completely wrong chord roots. The current miss-analysis report has 471 remaining chord misses, with same-root major/minor opportunities collapsed to power chords reduced to 5.
...
The quality breakdown currently shows major 436/500 exact and 440/500 simplified, minor 192/255 exact and 197/255 simplified, sus2 53/88, sus4 44/88, 7th 87/160 exact and 101/160 simplified, maj7 84/202 exact and 121/202 simplified, m7 81/173 exact and 90/173 simplified, 9th 14/38 exact and 23/38 simplified, add9 31/61 exact and 39/61 simplified, 6th 79/173 exact and 106/173 simplified, m6 30/57 exact and 34/57 simplified, dim 14/26, m7b5 24/57, power 1/2, maj9 2/6 exact and 3/6 simplified, aug 1/27, dim7 0/8, and augmented/diminished-seventh shapes still weak.
