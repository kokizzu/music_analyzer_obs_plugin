...
Current local results are 4,371/5,451 pitch-class hits, 66.67% guitar precision, 80.19% guitar recall, 72.81% guitar F1, and 970/1,491 exact chord hits: 595/752 major/minor opportunities and 375/739 other-chord opportunities.
The same run reports 1,067/1,491 simplified-compatible chord hits, including 606/752 major/minor opportunities; this distinguishes missed extensions from completely wrong chord roots. The current miss-analysis report has 521 remaining chord misses, with same-root major/minor opportunities collapsed to power chords reduced to 22.
