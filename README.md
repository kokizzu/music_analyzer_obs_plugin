...
- `BPM`: bottom-right estimated tempo. The percentage is confidence from recent weighted drum/onset periodicity, so sparse intros, rubato, or weak drums may show `BPM --` or a low-confidence estimate.
