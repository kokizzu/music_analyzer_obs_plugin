...
class DetectionAccuracyReportTest(unittest.TestCase):
    ...
    def test_render_reports_global_and_family_counts(self) -> None:
        ...
        self.assertIn("| Reject live permissive-tracker fallback | 1 / 1 (100.0%) | 0 |", report)
        self.assertIn("| Reject lowering permissive fallback certainty to 0.60 | 1 / 1 (100.0%) | 0 |", report)
