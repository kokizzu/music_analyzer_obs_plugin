						       ...
						       const SampleRow &row)
{
	...
	if (row.note == "C2")
		return true;
	if ((row.note == "C1") &&
	    (row.program_name == "acoustic_grand" || row.program_name == "bright_acoustic" ||
	     row.program_name == "electric_grand" || row.program_name == "honky_tonk" ||
	     row.program_name == "electric_piano_2" || row.program_name == "harpsichord" ||
	...
	if ((row.note == "E1") &&
	    (row.program_name == "acoustic_grand" || row.program_name == "bright_acoustic" ||
	     row.program_name == "electric_grand" || row.program_name == "honky_tonk" ||
	     row.program_name == "electric_piano_2" || row.program_name == "harpsichord" ||
	     row.program_name == "electric_piano_1" || row.program_name == "clavinet"))
		return true;
	if ((row.note == "G1") &&
	    (row.program_name == "acoustic_grand" || row.program_name == "bright_acoustic" ||
	     row.program_name == "electric_grand" || row.program_name == "honky_tonk" ||
	...
	return (suite_family == "strings" &&
		((row.program_name == "violin" && (row.note == "G3" || row.note == "C6")) ||
		 ...
		 (row.program_name == "contrabass" &&
		  (row.note == "E1" || row.note == "G1" || row.note == "C2" || row.note == "B2" ||
		   row.note == "E3")) ||
		 (row.program_name == "tremolo_strings" &&
		  (row.note == "C2" || row.note == "E2" || row.note == "G2" || row.note == "E3")) ||
		...
		((row.program_name == "metallic_pad" && row.note == "G3") ||
		 ...
		 (row.program_name == "saw_lead" &&
		  (row.note == "C2" || row.note == "G2" || row.note == "G3" || row.note == "C4" ||
		   row.note == "C5")) ||
		 (row.program_name == "bass_and_lead" && row.note == "G3") ||
		 (row.program_name == "chiff_lead" && row.note == "C5") ||
