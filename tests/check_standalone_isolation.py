...
def main():
    ...
    bass_guitar_icon_header = (ROOT / "src" / "app_icon_bass_guitar_rgba.hpp").read_text(encoding="utf-8")
    ...
    require("APP_ICON_HEADER" in makefile and "BASS_GUITAR_APP_ICON_HEADER" in makefile and
            "BASS_GUITAR_ICON_SOURCE" in makefile and "icon-assets:" in makefile and
            "scripts/generate_icon_assets.sh" in makefile,
            "Makefile must regenerate flavor-specific desktop and Android icon assets")
    ...
    require("kHalfMusicKeyboardFirstRow = 1" in renderer and "kHalfMusicKeyboardRowCount = 2" in renderer and
            ...
            "draw_note_column_headers(visualizer, layout, 158 + y_shift)" in renderer,
    ...
    require("cpu_percent" in renderer and "ram_mb" in renderer and "battery_percent" in renderer and
            ...
            '" BAT+ %.0f"' in renderer and '" BAT %.0f"' in renderer and '" BAT %.0f%%"' not in renderer and
    ...
    require("SDL_SetWindowIcon" in standalone and "SDL_CreateRGBSurfaceWithFormatFrom" in standalone and
            "app_icon_bass_guitar_rgba.hpp" in standalone and "kAppIconRgba" in icon_header and
