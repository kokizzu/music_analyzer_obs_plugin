...
def main():
    ...
    require("dimChannel(red),\n                        dimChannel(green)," in fret_zealot_sdk_controller and
            "dimBlueChannel(red, green, blue),\n                        LOWEST_SDK_INTENSITY" in fret_zealot_sdk_controller and
            "VIOLET_BLUE_CHANNEL_LEVEL = 4" in fret_zealot_sdk_controller,
    ...
    require("dimChannel(red)," in fret_zealot_sdk_controller and
            "dimChannel(green)," in fret_zealot_sdk_controller and
            "dimBlueChannel(red, green, blue)," in fret_zealot_sdk_controller,
