...
def main():
    ...
    print(
        ...
        "catalog=URMP+MusicNet+MedleyDB+MulTTiPop+Spheres+GuitarSet+MAESTRO+E-GMD, target=test-real-goal-20, "
        "fixture=URMP+MusicNet+MedleyDB+MulTTiPop-audio+Spheres+GuitarSet+MAESTRO+E-GMD, "
