...
def main():
    try:
        ...
        synthsod_archives = read_text("tests/prepare_synthsod_archives.py")
    ...
    for text, needle, context in (
        ...
        (analyzer_header, "pending_bass_hits_",
         "bass detection confirms candidate switches temporally"),
        (analyzer_impl, "strong_replacement",
         "bass detection has confidence-gated strong replacement path"),
        (analyzer_cases, "check_full_mix_bass_conservative_switching",
         "full-mix bass conservative switching regression"),
        (analyzer_header, "tracked_vocal_midi_",
         "full-mix vocal detection keeps monophonic continuity state"),
        (analyzer_impl, "stabilize_full_mix_vocal_ownership",
         "full-mix vocal ownership requires temporal confirmation"),
        (analyzer_cases, "check_full_mix_vocal_requires_temporal_confirmation",
         "full-mix vocal temporal confirmation regression"),
        (analyzer_header, "full_mix_other_ownership_tracking_",
         "full-mix other sparse ownership keeps temporal confirmation state"),
        (analyzer_impl, "stabilize_sparse_full_mix_other_ownership",
        ...
        (analyzer_impl, "suppress_full_mix_bass_duplicate_ownership",
         "accepted full-mix bass MIDI is removed from non-bass owner rows"),
        ...
        (makefile, "tests/prepare_synthsod_archives.py", "Makefile SynthSOD archive extraction"),
        ...
        (makefile, "extract-real-synthsod-archives", "Makefile optional SynthSOD archive extraction"),
        (makefile, "test-real-synthsod-20", "Makefile optional SynthSOD analyzer gate"),
        (makefile, "test-synthsod-archive-extract", "Makefile SynthSOD archive fixture gate"),
        ...
        (musicnet_harness, "MusicNet real-mix pitch precision", "MusicNet precision gate"),
        (musicnet_harness, "MusicNet real-mix global chord precision", "MusicNet global chord precision gate"),
        (musicnet_harness, "global chord precision", "MusicNet global chord precision report"),
        (readme, "MUSIC_ANALYZER_MUSICNET_MIN_PRECISION_PERCENT", "README MusicNet precision knob"),
        (readme, "MUSIC_ANALYZER_MUSICNET_MIN_GLOBAL_CHORD_PRECISION_PERCENT", "README MusicNet global chord precision knob"),
        (docs, "chord recall/precision/F1", "dataset docs MusicNet precision metrics"),
        ...
        (multtipop_harness, "MulTTiPop real-pop pitch precision", "MulTTiPop real-audio precision gate"),
        (multtipop_harness, "MulTTiPop real-pop global chord precision", "MulTTiPop global chord precision gate"),
        (multtipop_harness, "global chord precision", "MulTTiPop global chord precision report"),
        (multtipop_harness, "chord hits", "MulTTiPop chord recall report"),
        (readme, "MUSIC_ANALYZER_MULTTIPOP_MIN_PRECISION_PERCENT", "README MulTTiPop precision knob"),
        (docs, "pitch-class recall/precision/F1", "dataset docs MulTTiPop precision metrics"),
        ...
        (synthsod_archives, "MUSIC_ANALYZER_SYNTHSOD_AUDIO_ZIP", "SynthSOD archive audio zip environment"),
        (synthsod_archives, "MUSIC_ANALYZER_SYNTHSOD_SCORES_ZIP", "SynthSOD archive score zip environment"),
        (synthsod_archives, "safe_extract", "SynthSOD archive safe extraction"),
        (synthsod_archives, "unsafe archive member", "SynthSOD archive traversal rejection"),
        (synthsod_archives, "find_audio_root", "SynthSOD archive extracted audio root discovery"),
        ...
        (maestro_harness, "MAESTRO keyboard precision", "MAESTRO analyzer precision gate"),
        (maestro_harness, "MAESTRO cross-row contamination", "MAESTRO analyzer contamination gate"),
        (maestro_harness, "MAESTRO false non-keyboard detection", "MAESTRO analyzer false-row gate"),
        (maestro_harness, "MAESTRO keyboard chord precision", "MAESTRO isolated keyboard chord precision gate"),
        (maestro_harness, "chord hits", "MAESTRO chord recall report"),
        (readme, "MUSIC_ANALYZER_MAESTRO_MIN_PRECISION_PERCENT", "README MAESTRO precision knob"),
        (readme, "MUSIC_ANALYZER_MAESTRO_MAX_CONTAMINATION_PERCENT", "README MAESTRO contamination knob"),
        (docs, "keyboard-row precision/recall/F1", "dataset docs MAESTRO precision metrics"),
        ...
        (egmd_harness, "E-GMD drum precision", "E-GMD real-audio precision gate"),
        (egmd_harness, "E-GMD drum false-positive windows", "E-GMD false-positive drum gate"),
        (egmd_harness, "fp by category", "E-GMD false-positive drum category report"),
        (egmd_harness, "drum hits", "E-GMD drum recall report"),
        (readme, "MUSIC_ANALYZER_EGMD_MIN_PRECISION_PERCENT", "README E-GMD precision knob"),
        (docs, "drum-category recall/precision/F1", "dataset docs E-GMD precision metrics"),
        ...
        (guitarset_harness, "GuitarSet guitar precision", "GuitarSet analyzer precision gate"),
        (guitarset_harness, "GuitarSet cross-row contamination", "GuitarSet analyzer contamination gate"),
        (guitarset_harness, "GuitarSet false vocal detection", "GuitarSet analyzer false-vocal gate"),
        (guitarset_harness, "GuitarSet guitar chord precision", "GuitarSet isolated guitar chord precision gate"),
        ...
        (readme, "Ambiguous notes can still support the global chord",
         "README ambiguous ownership explanation"),
        (readme, "Full-mix per-instrument rows are conservative estimates",
         "README full-mix limitation explanation"),
        (readme, "The primary chord for OBS and standalone output is the shared global chord",
         "README global versus per-instrument chord explanation"),
        (readme, "`IsolatedBass`, `IsolatedGuitar`, `IsolatedKeyboard`, `IsolatedVocal`, and `IsolatedOther`",
         "README isolated input mode explanation"),
        (readme, "Source-name hints such as `guitar`, `piano`, or `vocal` are only a compatibility adapter",
         "README source-name compatibility limitation"),
        ...
        (readme, "make extract-real-synthsod-archives", "README SynthSOD archive extraction instructions"),
        (readme, "make test-real-synthsod-20", "README SynthSOD analyzer instructions"),
        (readme, "MUSIC_ANALYZER_SYNTHSOD_AUDIO_ZIP", "README SynthSOD audio zip instructions"),
        ...
        (docs, "make extract-real-synthsod-archives", "dataset docs SynthSOD archive extraction instructions"),
        (docs, "make test-real-synthsod-20", "dataset docs SynthSOD analyzer instructions"),
        (docs, "MUSIC_ANALYZER_SYNTHSOD_AUDIO_ZIP", "dataset docs SynthSOD audio zip instructions"),
