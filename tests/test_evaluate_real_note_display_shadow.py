    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        guarded_other_vocal_path.write_text(
            ...
            + "\n".join(
                ...
                for item in (
                    row(
                        sample_id="measured_other_vocal_clear_formant_shadow",
                        family="other",
                        source="acoustic",
                        expected_note="F4",
                        expected_midi="65",
                    ...
                    row(
                        ...
                        guitar_notes="",
                        piano_notes="",
                        vocal_notes="F#4:0.42",
                        other_notes="F#4:0.88",
                    ),
                    row(
                        sample_id="protected_dense_vocal_body",
                        family="vocals",
                        source="acoustic",
                        expected_note="D#4",
                        expected_midi="63",
                        ...
                        guitar_notes="",
                        piano_notes="",
                        vocal_notes="D#4:0.42",
                        other_notes="D#4:1.00",
                    ),
                )
            )
            + "\n",
