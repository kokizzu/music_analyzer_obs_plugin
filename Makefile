...
GUITAR_TECHS_CHORD_MIN_CHORD_RECALL_PERCENT ?= 86
GUITAR_TECHS_CHORD_MIN_CHORD_PRECISION_PERCENT ?= 86
...
GUITAR_CHORD_MIX_MIN_CHORD_RECALL_PERCENT ?= 70
GUITAR_CHORD_MIX_MIN_CHORD_PRECISION_PERCENT ?= 78
...
GUITARSET_MIN_CHORD_RECALL_PERCENT ?= 66
GUITARSET_MIN_CHORD_PRECISION_PERCENT ?= 70
GUITARSET_MIN_MAJOR_MINOR_CHORD_RECALL_PERCENT ?= 79
GUITARSET_MIN_OTHER_CHORD_RECALL_PERCENT ?= 51
GUITARSET_MIN_SIMPLE_CHORD_RECALL_PERCENT ?= 71
GUITARSET_MIN_SIMPLE_MAJOR_MINOR_CHORD_RECALL_PERCENT ?= 80
GUITARSET_MIN_SIMPLE_OTHER_CHORD_RECALL_PERCENT ?= 62
...
REAL_NOTE_FULL_MIX_MIN_EXPECTED_ROW_PERCENT ?= 50
REAL_NOTE_FULL_MIX_MIN_BASS_EXPECTED_ROW_PERCENT ?= 65
REAL_NOTE_FULL_MIX_MIN_GUITAR_EXPECTED_ROW_PERCENT ?= 35
REAL_NOTE_FULL_MIX_MIN_PIANO_EXPECTED_ROW_PERCENT ?= 60
REAL_NOTE_FULL_MIX_MIN_VOCALS_EXPECTED_ROW_PERCENT ?= 90
REAL_NOTE_FULL_MIX_MIN_OTHER_EXPECTED_ROW_PERCENT ?= 50
