...
DRUM_SAMPLE_MIN_SNARE_RECALL_PERCENT ?= 55
...
DRUM_SAMPLE_SPREAD_MIN_SNARE_RECALL_PERCENT ?= 64
...
DRUM_SAMPLE_FULL_MIN_SNARE_RECALL_PERCENT ?= 68
...
HF_DRUM_KIT_MIN_SNARE_PRIMARY_PERCENT ?= 80
...
HF_DRUM_KIT_MIN_RIM_PRIMARY_PERCENT ?= 40
...
IDMT_DRUMS_LIMIT_PER_CATEGORY ?= 300
...
GUITAR_TECHS_CHORD_MIN_WINDOWS ?= 120
GUITAR_TECHS_CHORD_MIN_RECALL_PERCENT ?= 55
GUITAR_TECHS_CHORD_MIN_PRECISION_PERCENT ?= 45
GUITAR_TECHS_CHORD_MIN_GUITAR_RECALL_PERCENT ?= 55
GUITAR_TECHS_CHORD_MIN_CHORD_RECALL_PERCENT ?= 35
...
GUITAR_CHORD_MIX_MIN_CHORD_RECALL_PERCENT ?= 57
...
GUITARSET_MIN_CHORD_RECALL_PERCENT ?= 51
GUITARSET_MIN_CHORD_PRECISION_PERCENT ?= 53
GUITARSET_MIN_MAJOR_MINOR_CHORD_RECALL_PERCENT ?= 68
GUITARSET_MIN_OTHER_CHORD_RECALL_PERCENT ?= 33
GUITARSET_MIN_SIMPLE_CHORD_RECALL_PERCENT ?= 61
GUITARSET_MIN_SIMPLE_MAJOR_MINOR_CHORD_RECALL_PERCENT ?= 69
GUITARSET_MIN_SIMPLE_OTHER_CHORD_RECALL_PERCENT ?= 53
...
IDMT_BASS_LINES_MAX_FAILURES ?= 20
...
test-idmt-drums-samples: $(BUILD_DIR)/analyzer_drum_samples prepare-idmt-drums-samples scripts/run_with_duration.sh
	$(RUN_WITH_DURATION) analyzer_idmt_drums_samples env MUSIC_ANALYZER_DRUM_SAMPLES_REQUIRED=1 MUSIC_ANALYZER_DRUM_SAMPLES_DIR="$(IDMT_DRUMS_SAMPLE_DIR)" MUSIC_ANALYZER_DRUM_SAMPLE_REQUIRED_CATEGORIES="kick,snare,hihat" MUSIC_ANALYZER_DRUM_SAMPLE_MIN_RECALL_PERCENT="$(IDMT_DRUMS_MIN_RECALL_PERCENT)" MUSIC_ANALYZER_DRUM_SAMPLE_MIN_PRECISION_PERCENT="$(IDMT_DRUMS_MIN_PRECISION_PERCENT)" $(BUILD_DIR)/analyzer_drum_samples
...
test-real-world-samples-full: test-real-world-samples test-guitar-techs-samples test-guitar-techs-chord-samples test-guitar-chord-mix-samples test-gaps-guitar-samples test-idmt-guitar-samples test-philharmonia-samples-full test-tinysol-samples
