...
.PHONY: analyze-vocalset-full-mix-attributes find-vocalset-full-mix-row-confusion-patterns
...
find-vocalset-full-mix-row-confusion-patterns: $(VOCALSET_FULL_MIX_ATTRIBUTE_TSV) scripts/find_real_note_attribute_patterns.py
	$(PYTHON) scripts/find_real_note_attribute_patterns.py "$(VOCALSET_FULL_MIX_ATTRIBUTE_TSV)" $(if $(PATTERN_BUCKET),--bucket "$(PATTERN_BUCKET)") --bucket-status row_confusion $(REAL_NOTE_RUNTIME_ROW_CONFUSION_EXCLUDES) --jobs "$(REAL_NOTE_PATTERN_JOBS)" $(or $(PATTERN_ARGS),$(MEASURE_REAL_NOTE_FOCUSED_ROW_CONFUSION_PATTERN_ARGS))
...
DETECTOR_SAMPLE_REGRESSION_TARGETS := test-analyzer-cases test-real-note-samples-parallel test-real-note-samples-full-mix-detector-parallel test-real-note-visual-strength test-guitar-fretboard-note-samples-parallel test-guitar-techs-samples-parallel test-guitar-techs-chord-samples-parallel test-egfxset-guitar-samples-parallel test-gaps-guitar-samples-parallel test-downloaded-guitarset-parallel $(DRUM_REAL_WORLD_SAMPLE_TARGETS) test-drum-machine-samples-optional test-idmt-bass-lines-samples-optional test-idmt-guitar-samples-optional test-philharmonia-samples-parallel test-philharmonia-samples-full-parallel test-iowa-piano-samples-parallel test-iowa-bass-samples-parallel test-iowa-strings-samples-parallel test-iowa-orchestra-samples-parallel test-maps-piano-samples-optional test-maps-piano-note-samples-optional test-bach10-mf0-synth-samples-optional test-tinysol-samples-parallel test-vocadito-samples-parallel test-vocadito-samples-full-mix-parallel test-vocalset-samples-optional test-vocalset-samples-full-mix-optional test-instrument-samples-parallel test-drum-samples-full-parallel-optional
