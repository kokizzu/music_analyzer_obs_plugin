...
EXTRA_COMPONENT_ARGS ?= --simulate-prune primary-equivalent --simulate-prune primary-equivalent-plain --simulate-prune primary-same-root-equivalent --simulate-prune observed-playable --simulate-prune primary-equivalent-observed-playable
