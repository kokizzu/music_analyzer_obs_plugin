...
DETECTOR_SAMPLE_REGRESSION_TARGETS := test-analyzer-cases test-real-note-samples-full-mix-parallel test-guitar-chord-mix-samples $(DRUM_REAL_WORLD_SAMPLE_TARGETS) test-instrument-samples-parallel
