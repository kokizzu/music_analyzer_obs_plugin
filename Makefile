...
BEAT_THIS_DIAGNOSTIC_LOG ?= $(BUILD_DIR)/beat_this_gtzan_rhythm_bpm_diagnostics.log
BEAT_THIS_DIAGNOSTIC_MODEL ?= small0
...
.PHONY: evaluate-owner-classifier-loco evaluate-owner-classifier-quality-loco test-evaluate-owner-classifier-loco
