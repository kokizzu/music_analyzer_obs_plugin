...
.PHONY: resolve-pixabay-rimshot-candidate
...
download-pixabay-rimshot-candidate: configure-instrument-sample-store scripts/download_pixabay_rimshot_candidate.sh
	$(SHELL) scripts/download_pixabay_rimshot_candidate.sh "$(PIXABAY_RIMSHOT_MP3)" "$(PIXABAY_RIMSHOT_WAV)" "$(PIXABAY_RIMSHOT_URL)" "$(PIXABAY_RIMSHOT_SHA256)"
