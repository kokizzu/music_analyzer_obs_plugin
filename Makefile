...
DETECTION_ACCURACY_URMP_GOOD_SOUNDS_SAX_SHARED_PATTERN_ARG = --urmp-good-sounds-sax-shared-pattern-audit "$(URMP_GOOD_SOUNDS_SAX_SHARED_PATTERN_REPORT)"
...
update-detection-accuracy-report: $(BUILD_DIR)/real_note_full_mix_attributes.tsv $(GUITAR_CHORD_PRIMARY_DISPLAY_AUDIT) $(GUITAR_CHORD_TONE_RECOVERY_AUDIT) $(URMP_GOOD_SOUNDS_SAX_SHARED_PATTERN_REPORT) inspect-high-vocal-octave-evidence-cached scripts/write_detection_accuracy_report.py
...
update-detection-accuracy-report-cached: $(GUITAR_CHORD_PRIMARY_DISPLAY_AUDIT) $(GUITAR_CHORD_TONE_RECOVERY_AUDIT) $(URMP_GOOD_SOUNDS_SAX_SHARED_PATTERN_REPORT) inspect-high-vocal-octave-evidence-cached scripts/write_detection_accuracy_report.py
