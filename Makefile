...
DRUM_SAMPLE_FULL_MIN_TOM_PRIMARY_PERCENT ?= 65
DRUM_SAMPLE_FULL_MIN_RIDE_PRIMARY_PERCENT ?= 58
DRUM_SAMPLE_FULL_MIN_RIM_PRIMARY_PERCENT ?= 70
...
GUITAR_CHORD_MIX_MIN_CHORD_HITS ?= 475
...
VOCADITO_FULL_MIX_MIN_VOCALS_EXPECTED_ROW_PERCENT ?= 60
...
.PHONY: test-drum-samples-full-serial test-drum-samples-full-parallel test-drum-samples-full-parallel-unlocked test-drum-samples-full-shard-% test-hf-drum-kit-samples-serial test-hf-drum-kit-samples-parallel test-hf-drum-kit-samples-shard-% test-idmt-drums-samples-serial test-idmt-drums-samples-parallel test-idmt-drums-samples-shard-% test-drum-samples-full-parallel-optional test-drum-sample-shard-check
...
.PHONY: detector-improvement-samples detector-improvement-patterns detector-improvement-routes detector-improvement-route-report detector-improvement-route-summary detector-improvement-samples-full detector-improvement-patterns-full analyze-detector-improvements analyze-detector-improvement-routes analyze-detector-improvements-full
...
test-real-note-samples-full-mix-parallel: $(BUILD_DIR)/analyzer_real_note_samples scripts/run_with_duration.sh scripts/check_real_note_full_mix_shards.py
	...
	+$(RUN_WITH_DURATION) analyzer_real_note_samples_full_mix_parallel $(MAKE) $(REAL_NOTE_FULL_MIX_TEST_MAKE_JOBS) REAL_NOTE_FULL_MIX_SHARD_OUTPUT_PREFIX="$(REAL_NOTE_FULL_MIX_SHARD_OUTPUT_PREFIX)" $(REAL_NOTE_FULL_MIX_SHARD_TARGETS)
...
DETECTOR_IMPROVEMENT_ROUTE_SCAN_TARGETS := find-real-note-focused-row-confusion-patterns find-real-note-focused-visual-row-confusion-patterns find-real-note-ownership-patterns evaluate-real-note-display-shadow-all find-vocadito-full-mix-ownership-patterns find-vocadito-full-mix-broad-vocal-ownership-patterns find-vocadito-full-mix-visual-row-confusion-patterns find-instrument-owner-patterns find-instrument-status-patterns find-drum-full-exact-attribute-patterns-cached
