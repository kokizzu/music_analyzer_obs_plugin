...
DRUM_MACHINE_MAX_TOM_FALSE_PERCENT ?= 70
...
MDB_DRUMS_MIN_PRECISION_PERCENT ?= 35
MDB_DRUMS_MAX_FALSE_POSITIVE_WINDOWS_PERCENT ?= 91
...
GUITAR_TECHS_CHORD_MIN_CHORD_RECALL_PERCENT ?= 84
GUITAR_TECHS_CHORD_MIN_CHORD_PRECISION_PERCENT ?= 84
...
GUITAR_CHORD_MIX_MIN_CHORD_RECALL_PERCENT ?= 67
GUITAR_CHORD_MIX_MIN_CHORD_PRECISION_PERCENT ?= 75
...
GAPS_GUITAR_MIN_CHORD_RECALL_PERCENT ?= 50
GAPS_GUITAR_MIN_CHORD_PRECISION_PERCENT ?= 54
...
GUITARSET_MIN_CHORD_RECALL_PERCENT ?= 63
GUITARSET_MIN_CHORD_PRECISION_PERCENT ?= 66
GUITARSET_MIN_MAJOR_MINOR_CHORD_RECALL_PERCENT ?= 75
GUITARSET_MIN_OTHER_CHORD_RECALL_PERCENT ?= 47
GUITARSET_MIN_SIMPLE_CHORD_RECALL_PERCENT ?= 68
GUITARSET_MIN_SIMPLE_MAJOR_MINOR_CHORD_RECALL_PERCENT ?= 77
GUITARSET_MIN_SIMPLE_OTHER_CHORD_RECALL_PERCENT ?= 59
