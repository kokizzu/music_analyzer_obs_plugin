...
.PHONY: analyze-drum-spread-gate-matrix analyze-drum-full-gate-matrix find-drum-spread-exact-attribute-patterns find-drum-full-exact-attribute-patterns test-drum-gate-matrix-summary test-drum-active-threshold-simulation
