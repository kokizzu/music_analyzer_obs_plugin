...
DETECTOR_SAMPLE_REGRESSION_TARGETS := test-analyzer-cases test-real-note-samples-full-mix-detector-parallel test-real-note-visual-strength test-guitar-chord-mix-samples-parallel $(DRUM_REAL_WORLD_SAMPLE_TARGETS) test-drum-machine-samples-optional test-idmt-bass-lines-samples-optional test-idmt-guitar-samples-optional test-iowa-strings-samples test-iowa-orchestra-samples test-tinysol-samples test-vocadito-samples test-vocadito-samples-full-mix-parallel test-vocalset-samples-optional test-instrument-samples-parallel test-drum-samples-full-parallel-optional
