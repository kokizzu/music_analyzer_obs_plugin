...
.PHONY: test-parallel test-core-parallel test-analysis-scripts-parallel test-real-note-samples-full-mix-parallel test-analyzer-smoke test-analyzer-cases test-analyzer-midi-ranges test-analyzer-urmp test-analyzer-musicnet test-analyzer-multtipop test-analyzer-guitarset test-analyzer-maestro test-analyzer-egmd
...
DETECTOR_SAMPLE_REGRESSION_TARGETS := test-analyzer-cases test-real-note-samples-full-mix-parallel test-guitar-chord-mix-samples $(DRUM_REAL_WORLD_SAMPLE_TARGETS) test-instrument-samples
